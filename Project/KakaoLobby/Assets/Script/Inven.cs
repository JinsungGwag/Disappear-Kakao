...
public class Inven : MonoBehaviour
{
    ...
    // Data save
    public void BinarySerialize(Item it, string filePath)
    {
    ...
    public void Awake()
    {
        ...
        realPath = Application.persistentDataPath + "/Inven.bin";
    ...
    // Push skin in inventory
    public void putSkin(string itName)
    {
        realItem.Skin.Add(itName);
